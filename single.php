...
<?php get_sidebar('page'); ?>
    <section id="first-block">
      <image src="<?php get_template_directory_uri(); ?>/img/first-back-s.jpg" class="first-back-s"></image>
      <image src="<?php get_template_directory_uri(); ?>/img/first-back-pc.jpg" class="first-back-pc"></image>
    </section>
    <section id="second-block">
        <div class="movie-container">
        　<h2>MOVIE</h2>
          <image src="<?php get_template_directory_uri(); ?>/img/YouTube.jpg" class="YouTube-image"></image>
          <p class="info-text">
            <u>近日公開･･･！</u>
          </p>
        </div>
    ...
    <section id="third-block">
      <image src="<?php get_template_directory_uri(); ?>/img/event.png" class="event"></image>
    </section>
                ...
                <input type="checkbox" id="label1" class="cssacc" />
                  <div class="card-index">
                    <article class="shop-card">
                      ...
                      <img class="card-img" src="<?php get_template_directory_uri(); ?>/img/rotto.png" alt="">
                    ...
                    <article class="shop-card">
                      <h5>浪漫須貯古齢糖</h5> 
                      <img class="card-img" src="<?php get_template_directory_uri(); ?>/img/romance.png" alt="">
                      <p class="card-text">世界各国から厳選した高品質のカカオのみを選別、自家焙煎されている「浪漫須貯古齢糖」。カカオの魅力や可能性を最大限に活かし、ワンランク上のクラフトチョコレート作作られています。</p>
                      <p class="card-address">〒036－8332 <br>弘前市亀甲町5　　 0172-88-9015</p>
                    </article>
                    <article class="shop-card">
                      <h5>ジョージのおやつ</h5> 
                      <img class="card-img" src="<?php get_template_directory_uri(); ?>/img/George.png" alt="">
                    ...
                    <article class="shop-card">
                      <h5>コトリcafe</h5> 
                      <img class="card-img" src="<?php get_template_directory_uri(); ?>/img/kotoricafe.png" alt="">
                      <p class="card-text">カフェ兼スイーツ・ケーキショップの「ジョージのおやつ」。お菓子教室やイベント出店なども行っており、楽しい時も、苦しい時も、いつもあなたのそばに寄り添える、そんなおやつを提供されています。</p>
                      <p class="card-address">〒036－8035 <br>弘前市百石町3-2　　0172-88-8504</p>
                    </article>
                    <article class="shop-card">
                      <h5>カフェ デュボワ</h5> 
                      <img class="card-img" src="<?php get_template_directory_uri(); ?>/img/duboa.png" alt="">
                      <p class="card-text">カフェ兼スイーツ・ケーキショップの「ジョージのおやつ」。お菓子教室やイベント出店なども行っており、楽しい時も、苦しい時も、いつもあなたのそばに寄り添える、そんなおやつを提供されています。</p>
                      <p class="card-address">〒036－8035 <br>弘前市百石町3-2　　0172-88-8504</p>
                    </article>
                    <article class="shop-card">
                      <h5>二階堂</h5> 
                      <img class="card-img" src="<?php get_template_directory_uri(); ?>/img/nikaido.png" alt="">
                ...
                <input type="checkbox" id="label2" class="cssacc" />
                  <div class="craft-index">
                    <div class="craft-card">
                      <img class="img" src="<?php get_template_directory_uri(); ?>/img/kogin.jpg" alt="">
        ...
        <div class="note-container">
          ...
          <ul>
            <li>イベント当日時点での新型コロナウイルス感染症対策専門会議の発表を踏まえ、<br>
              各個人において対策を講じていただけるようお願いいたします。</li>
            <li>イベント会場は振動に弱いため、強い振動が起こる作業はお控えください。</li>
